...
function getAvailableModules(projectPath) {
...
async function interactiveRetry() {
...
export async function runInteractive() {
    ...
    choices.push({ name: `Apply       ${chalk.dim("Apply decorators and DTOs to controllers")}`, value: "apply" }, { name: `Parse       ${chalk.dim("Analyze project endpoints")}`, value: "parse" }, { name: `Init        ${chalk.dim("Create .documentator.json config")}`, value: "init" }, { name: `Help        ${chalk.dim("Show CLI usage")}`, value: "help" });
